...
foreach (array_splice($posts, 0, 14) as $post) {
    $dist_md .= "- <img src=\"platform_icons/${post['type']}.png\" width=\"16\"> [${post['title']}](${post['url']}) [![はてなブックマーク数](https://b.hatena.ne.jp/entry/image/${post['url']})](https://b.hatena.ne.jp/entry/${post['url']})\n";
}
